...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { chapter_name: @chapter.chapter_name, fraternity: @chapter.fraternity }
    end
  ...
  test "should update chapter" do
    put :update, id: @chapter, chapter: { chapter_name: @chapter.chapter_name, fraternity: @chapter.fraternity }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
